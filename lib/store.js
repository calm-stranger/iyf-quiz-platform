 ...
 * You can get these for free at https://upstash.com/
 */
...
function getStore() {
  ...
  // ── In-memory fallback ─────────────────────────────────────────────────────
  console.warn(
    '[store] No UPSTASH_REDIS_REST_URL found — using in-memory store. ' +
    'Data will be lost on server restart. Set up Upstash Redis for production.'
  );
